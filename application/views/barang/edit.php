            ...
            <div class="card-body">
               ...
               <div class="row form-group">
                        ...
                        <div class="input-group">
                            <select name="size_id" id="size_id" class="custom-select">
                                ...
                                <?php foreach ($size as $s) : ?>
                                    <option <?= $barang['size_id'] == $s['id_size'] ? 'selected' : ''; ?><?= set_select('size_id', $s['id_size']) ?> value="<?= $s['id_size'] ?>"><?= $s['nama_size'] ?></option>
                                <?php endforeach; ?>
                            </select>
                            <div class="input-group-append">
                        ...
                        <div class="input-group">
                            <select name="bahan_id" id="bahan_id" class="custom-select">
                                ...
                                <?php foreach ($bahan as $s) : ?>
                                    <option <?= $barang['bahan_id'] == $s['id_bahan'] ? 'selected' : ''; ?><?= set_select('bahan_id', $s['id_bahan']) ?> value="<?= $s['id_bahan'] ?>"><?= $s['nama_bahan'] ?></option>
                                <?php endforeach; ?>
                            </select>
                            <div class="input-group-append">
                        ...
                        <div class="input-group">
                            <select name="warna_id" id="warna_id" class="custom-select">
                                ...
                                <?php foreach ($warna as $s) : ?>
                                    <option <?= $barang['warna_id'] == $s['id_warna'] ? 'selected' : ''; ?><?= set_select('warna_id', $s['id_warna']) ?> value="<?= $s['id_warna'] ?>"><?= $s['nama_warna'] ?></option>
                                <?php endforeach; ?>
                            </select>
                            <div class="input-group-append">
                        ...
                        <div class="input-group">
                            <select name="mata_id" id="mata_id" class="custom-select">
                                ...
                                <?php foreach ($mata as $s) : ?>
                                    <option <?= $barang['mata_id'] == $s['id_mata'] ? 'selected' : ''; ?><?= set_select('mata_id', $s['id_mata']) ?> value="<?= $s['id_mata'] ?>"><?= $s['nama_mata'] ?></option>
                                <?php endforeach; ?>
                            </select>
                            <div class="input-group-append">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('keterangan', $barang['keterangan']); ?>" name="keterangan" id="keterangan" type="text" class="form-control" placeholder="Keterangan...">
