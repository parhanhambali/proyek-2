...
<head>
    ...
    <title><?= $title; ?> |  APLIKASI PENENTUAN DAN SHARE PROMO PRODUK</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">APLIKASI PENENTUAN DAN SHARE PROMO PRODUK</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-light py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('size'); ?>">Size Barang</a>
                        <a class="collapse-item" href="<?= base_url('bahan'); ?>">Bahan Barang</a>
                        <a class="collapse-item" href="<?= base_url('warna'); ?>">Warna Barang</a>
                        <a class="collapse-item" href="<?= base_url('mata'); ?>">Mata Uang</a>
                    <div class="bg-light py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Master Produk:</h6>
                        <a class="collapse-item" href="<?= base_url('barang'); ?>">Data Barang</a>
                        <a class="collapse-item" href="<?= base_url('barangmasuk'); ?>">Barang Masuk</a>
                        <a class="collapse-item" href="<?= base_url('hargaawal'); ?>">Harga Masuk</a>
                        <a class="collapse-item" href="<?= base_url('hargapromo'); ?>">Penentuan Promo Produk</a>
           ...
           <!-- <li class="nav-item">
                <a class="nav-link collapsed " href="#" data-toggle="collapse" data-target="#collapseMaster" aria-expanded="true" aria-controls="collapseMaster">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Penentuan Promo</span>
                </a>
                <div id="collapseMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-light py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Master Penentuan Promo:</h6>
                        <a class="collapse-item" href="<?= base_url('hargapromo'); ?>">Penentuan Promo Produk</a>
             ...
             <li class="nav-item">
                ...
                <div id="collapseMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-light py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('barangkeluar'); ?>">Data Penjualan</a>
                        <a class="collapse-item" href="<?= base_url('laporan'); ?>">Rekap Penjualan</a>
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; APLIKASI PENENTUAN DAN SHARE PROMO PRODUK 2020 &bull; by <?= anchor('https://if.poltekpos.ac.id/', 'Ravi&Parhan'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
